<template>
  <UContainer>
    ...
    <UCard v-if="data">
      <template #header>
        <h3 class="text-xl font-semibold">{{ data?.user.username ?? 'Child' }}'s Details</h3>
      </template>
      <template #default>
        ...
        <p v-else-if="wishlistStatus === 'pending'" class="text-gray-500">Loading wishlist...</p>
        <p v-else-if="wishlistError" class="text-red-500">{{ wishlistError.message }}</p>
        ...
        <p v-else-if="rewardsStatus === 'pending'" class="text-gray-500">Loading rewards...</p>
        <p v-else-if="rewardsError" class="text-red-500">{{ rewardsError.message }}</p>
